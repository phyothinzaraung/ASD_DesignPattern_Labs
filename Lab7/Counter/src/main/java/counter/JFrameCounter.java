...
public class JFrameCounter extends JFrame {
    ...
    public JFrameCounter() {
        try {
            ...
            DigitCountState state = new OneDigit(counter);
            counter.setDigitCountState(state);

            CounterValueReceiver counterValueReceiver = new CounterValueReceiver();
            counter.setCounterReceiver(counterValueReceiver);
            counter.setHandleState();
