...
public class Application {
	...
	public static void main(String[] args) {
		...
		Iterator<Customer> skipCustomerIterator = customerCollection.skipCustomerIterator();
		while (skipCustomerIterator.hasNext()){
			System.out.println(skipCustomerIterator.next());
		}
		...
		Predicate<Customer> customerInChicago = customer -> customer.getAddress().getCity().equals("Chicago");
		Iterator<Customer> customerIterator = customerCollection.customerIterator(customerInChicago);
		...
		Predicate<Customer> customerWithZipCode12 = customer -> customer.getAddress().getZip().startsWith("12");
		customerIterator = customerCollection.customerIterator(customerWithZipCode12);
		while (customerIterator.hasNext()){
			System.out.println(customerIterator.next());
		}
	}
